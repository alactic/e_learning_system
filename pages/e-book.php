...
if(isset($_GET["file"])){
	$category=$_GET['file'];
	$select_book=$connection->prepare("Select * from e_book where `category`='$category'");
	$select_book->execute();
}
...
<div class="wrapper col3">
  ...
  <?php while($fetch=$select_book->fetch()){ 
   echo "<span style='font-weight:bold'><a href='e-learning.php?file=uploads/".$fetch['dir_name']."'>-".$fetch['book_name']." </a></span></br></br>";
  }
  ?>
</div>
<!-- ####################################################################################################### -->
