	 ...
	 if(!isset($_SESSION['admin']))
   {
    ...
    }else
	{
	 ...
	 if(isset($_POST['edit_staff'])){
		 if($_POST['ed_staff']!=null)
		 {
		    $_SESSION['edit_staff']=$_POST['ed_staff'];
	 ...
	 if(isset($_POST['submit'])){
		 ...
		 $email=$_POST['email'];
		 $edit_name=$_SESSION['edit_staff'];
		 
		     $update=$connection->prepare("UPDATE `staff_login` SET `username`='$username', `password`='$pass', `email`='$email' WHERE `username`='$edit_name'");
	         $update->execute();
			 header("Location:admin_page.php");
			 exit();
		 }
