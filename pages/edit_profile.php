...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first"><h3 style="font-weight:bold">Staff Page</h3> <a href="staff_profile.php">Edit My Profile</a></li>
...
Qualification: <input type="text" name="name"><br/><br/>
Achievement: <input type="text" name="name"><br/><br/>
