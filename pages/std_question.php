...
session_start();		
	...
	$select_std=$connection->prepare("SELECT * FROM assignment WHERE `level`='$level' AND `submit_status`='open'");
	$select_std->execute();
  ...
  <div id="containe" style="color:#000;margin-left:100px">
    ...
    <?php
	    ...
	    while($fetch=$select_std->fetch())
		 {
			 echo "</br></br><a href='std_assign.php?assign=".$fetch['id']."'>Assignment on  ".$fetch['topic'];
		 }
		?>
